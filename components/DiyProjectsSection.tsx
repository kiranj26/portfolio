...
function VideoHeroCard({ project }: { project: Project }): React.ReactElement {
  ...
  return (
    <>
      <div
        className="relative rounded-xl border border-zinc-800 overflow-hidden cursor-pointer group"
        style={{ height: 320 }}
      ...
      >
        ...
        {/* Resting state: dark card with info */}
        ...
        {/* Hovered state: play button overlay */}
        ...
        >
          ...
          <div className="relative">
            <div className="absolute inset-0 rounded-full"
              style={{ animation: hovered ? "ping 1s cubic-bezier(0,0,0.2,1) infinite" : "none",
...
function TableRow({
  ...
  const topTags = project.stack.slice(0, 3)
  ...
  return (
    <>
      ...
      <tr
        className={cn(
          "border-b border-zinc-800/60 cursor-pointer group transition-colors",
          isExpanded ? "bg-zinc-900/60 border-cyan-900/40" : "hover:bg-zinc-900/40"
        )}
        onClick={onToggle}
      >
        {/* Row number */}
        <td className="py-3 pl-4 pr-3 font-mono text-[10px] text-zinc-700 select-none w-8">
          {rowNum}
        </td>
      ...
      {isExpanded && (
        <tr className="border-b border-cyan-900/30">
          <td colSpan={7} className="p-0">
            <div className="px-6 py-5 bg-zinc-900/50 border-l-2 border-cyan-800/60"
              ...
              <div className="flex flex-col md:flex-row gap-6">
                ...
                {/* Right: hardware info / thumbnail if available */}
          ...
          <div className="rounded-xl border border-zinc-800 overflow-hidden">
            ...
            <div className="flex items-center justify-between px-4 py-2.5 border-b border-zinc-800 bg-zinc-900/70">
              <div className="flex items-center gap-2">
                ...
                <span className="font-mono text-[9px] text-zinc-600 ml-2 tracking-widest">projects.index — {tableProjects.length} entries</span>
              </div>
